...
$vmhosts| ForEach-Object {$vmhosts.hostname} {
	...
	#====================================================================================================================
    $sw0nic1 = $vmhosts.sw0nic1
    $sw0nic1 = $sw0nic1.ToString()
	...
	#====================================================================================================================
	Get-VirtualSwitch $_.sw0name | Add-VirtualSwitchPhysicalNetworkAdapter -VMHostPhysicalNic $sw0nic1 -Mtu 1500 -Confirm:$false
